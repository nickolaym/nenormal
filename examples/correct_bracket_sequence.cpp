...
TEST(program, single_step) {
    // reduce pairs
    static_assert(success_data(program("---()---"_cts)) == "------"_cts);
    static_assert(success_data(program("---[]---"_cts)) == "------"_cts);
    static_assert(success_data(program("---{}---"_cts)) == "------"_cts);
    // unify unpaired
    static_assert(success_data(program("---(---"_cts)) == "---_---"_cts);
    static_assert(success_data(program("---[---"_cts)) == "---_---"_cts);
    static_assert(success_data(program("---{---"_cts)) == "---_---"_cts);
    static_assert(success_data(program("---)---"_cts)) == "---_---"_cts);
    static_assert(success_data(program("---]---"_cts)) == "---_---"_cts);
    static_assert(success_data(program("---}---"_cts)) == "---_---"_cts);
    // shrink unpaired
    static_assert(success_data(program("---__---"_cts)) == "---_---"_cts);
    // error_str message
    static_assert(success_data(program("---_---"_cts)) == "---ERROR---"_cts);
}

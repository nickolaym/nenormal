...
- [collatz_mini/](collatz_mini/README.md) - минимальная единеричная версия (схождение к 1)
- [collatz/](collatz/README.md) - единеричная версия, считающая длину последовательности
- [collatz_decimal/](collatz_decimal/README.md) - десятичная версия, считающая длину

Не могу пройти мимо, Коллац - это обязательное упражнение.

## Пример: арифметика

[arithmetics/](arithmetics/README.md) - сложение десятичных чисел.

Поскольку в последовательности Коллаца делается умножение на константу,
то почему бы не попробовать и двухместные операции? Оказалось реально.

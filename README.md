...
**TODO**: машина должна останавливаться также на специальной инструкции останова. Это пока не доделано. (См. ветку [dev/regular_final_rules](https://github.com/nickolaym/nenormal/tree/dev/regular_final_rules))
